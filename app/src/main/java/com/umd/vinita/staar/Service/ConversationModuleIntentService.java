...
public class ConversationModuleIntentService extends IntentService {
    ...
    private static final String EXTRA_PARAM2 = "com.umd.vinita.staar.Service.extra.PARAM2";
    ...
    public static void startActionFoo(Context context, String param1, String param2) {
        Intent intent = new Intent(context, ConversationModuleIntentService.class);
